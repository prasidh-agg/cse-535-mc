...
public class CaptureActivity extends AppCompatActivity {
    ...
    public static final String SERVER_URL = "http://172.20.10.7:80";
    ...
    public void uploadToServer() {
        ...
        Log.i("CAPTURE", "Delta path new - " + finalFileName);

        RequestParams fileUploadParameters = new RequestParams();

        fileUploadParameters.put("categoryvalue", dropDownValue);
        try {
        ...
        asyncHttpClient.post(CaptureActivity.this, finalUploadUrl, fileUploadParameters, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                Toast toast = Toast.makeText(getApplicationContext(), "Successful upload!", Toast.LENGTH_SHORT);
                toast.show();
            }
